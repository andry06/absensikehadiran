...
<table class="kehadiran">
  ...
  <tr>
    ...
    <td>&nbsp;:&nbsp;</td>
    <td> <input type="date" name="tanggal" id="tanggal" value="" placeholder="yyyy-mm-dd"> </td>
  </tr>
  <tr>
    <td><label for="jam_datang">Jam Datang</label> </td>
    <td>&nbsp;:&nbsp;</td>
    <td> <input type="time" name="jam_datang" id="jam_datang" placeholder="HH:ii (Format 24 Jam)"></td>
  </tr>
  <tr>
    <td><label for="jam_pulang">Jam Pulang</label> </td>
    <td>&nbsp;:&nbsp;</td>
    <td> <input type="time" name="jam_pulang" id="jam_pulang" placeholder="HH:ii (Format24 Jam)"></td>
  </tr>
  <tr>
    <td></td>
    <td></td>
